...
from librosa_analyzer import analyze
...
class LibrosaAnalyzerTest(unittest.TestCase):
    @classmethod
    ...
    def test_version_is_fixed(self) -> None:
        result = analyze(self.output / "s01.wav")
        self.assertEqual(result["engine"], {"name": "librosa", "version": "1.0.0"})
    ...
    def test_s02_finds_cycle_period_and_phase(self) -> None:
